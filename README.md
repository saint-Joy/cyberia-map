...
Master map of Cyber Valley (Gesing, Bali) — atoms × flats × intents.
...
- atom — 4×4×4 multipurpose cell: unit (1/2-pax), room (purpose = free
  prompt), custom wall grid 1×1×1
- molecule — several atoms joined direct / buffer / tube
